...
CELERY_QUEUES = (
    ...
    Queue('monitor',Exchange('mysql_gather'),routing_key='gather_mysql'),
    Queue('warning', Exchange('task_fail'), routing_key='task_fail'),
)
CELERY_ROUTES = {
    ...
    'myapp.include.scheduled.gather_mysql_info': {'queue': 'monitor', 'routing_key': 'gather_mysql'},
    'myapp.include.scheduled.gather_mysql_info_h': {'queue': 'monitor', 'routing_key': 'gather_mysql'},
    'myapp.include.scheduled.task_failed_wechart': {'queue': 'warning', 'routing_key': 'task_fail'},
}
